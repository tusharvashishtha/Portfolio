...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 0.3], [0, 500]);
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[140vh] md:min-h-[175vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100  bg-[#040404]">
      <motion.h2
        style={{
      ...
      <div
        ...
        <div
          ...
          <span className="text-white">
            <h1 className="font-[font3] text-sm font-semibold opacity-70 text-zinc-400">ABOUT ME</h1>
          </span>
        </div>
      </div>
      <motion.div

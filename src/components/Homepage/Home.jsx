...
const [disablePointer, setDisablePointer] = useState(false);
  ...
  return (
    <div className="h-screen relative overflow-hidden w-full flex flex-col items-center justify-center">
      ...
      <div className="group absolute bottom-4 right-5 bg-black h-10 w-35 rounded-2xl border-[0.1px] border-zinc-400 flex items-start justify-center cursor-pointer">
